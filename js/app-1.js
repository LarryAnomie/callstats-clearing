...
var APP = (function (w, d, $, _) {
    ...
    var SOL_URL = "sol.php?url=" + encodeURI("http://10.2.21.132:8181/WebDisplay.xml?NoCache="),    // source data url
        ...
        /*
         * Sets current group
         * @param {String} group - group name to show stats for
         * @return {Undefined}
         *
        */
    ...
    */
    ...
    $menu.on("click", "a", function(e) {
        var $this = $(e.target),
            thisGroup = $this.data("clearing-group");

        if ($this.is("span")) {
            $this = $this.parent("a");
        }

        APP.setGroup(thisGroup);

        $clearingTitle.text(thisGroup);
...
console.log((dataObj.missedTotal / dataObj.callsTotal) * 100);

                    // work out percentage of missed calls
                    dataObj.missedCalculated = (dataObj.missedTotal / dataObj.callsTotal) * 100;
